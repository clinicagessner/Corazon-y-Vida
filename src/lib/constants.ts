...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    "description": "Consulta anticonceptiva en Pasadena, TX: orientación sin juicios, inicio de pastillas o inyección en la clínica, seguimiento y efectos secundarios. Sin cita.",
  ...
  },
  {
    ...
    "description": "Electrocardiograma (EKG) en Pasadena, TX en minutos, sin dolor, interpretado por el médico: ritmo, frecuencia y señales de riesgo. Para chequeos y trámites.",
