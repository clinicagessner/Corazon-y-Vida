...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    "titleEn": "Pharmacy",
    "shortTitle": "Farmacia",
    "description": "Medicamentos en la clínica en Pasadena, TX: al terminar la consulta recibe los medicamentos indicados y productos de venta libre, con explicación en español.",
