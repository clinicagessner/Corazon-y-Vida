...
export const CONTACT_INFO: ContactInfo = {
  ...
  // WhatsApp: número distinto al teléfono de la clínica (el del Perfil de Negocio), en E.164 sin "+" (formato wa.me).
  ...
  whatsapp: "13466462974",
  whatsappFormatted: "+1 (346) 646-2974",
  email: "chcorazonyvida@gmail.com",
  hours: "Lunes a Domingo: 9:00 AM - 9:00 PM",
  hoursWeekday: "Lunes a Domingo: 9:00 AM - 9:00 PM",
  hoursWeekend: "Abierto los 7 días",
...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    "description": "Prueba de tuberculosis en Pasadena, TX: cutánea PPD con lectura a las 48-72 horas para trabajo y escuela, o de sangre IGRA para inmigración.",
  ...
  },
  {
    ...
    "shortTitle": "STD",
    "description": "Pruebas de infecciones de transmisión sexual en Pasadena, TX: VIH, sífilis, gonorrea, clamidia, hepatitis y herpes, confidenciales y con tratamiento.",
  ...
  },
  {
    ...
    "description": "Prueba de alcohol y drogas para empleo en Pasadena, TX: muestra de orina o aliento, cadena de custodia y documentación del resultado. Sin cita.",
  ...
  },
  {
    ...
    "shortTitle": "Suturas",
    "description": "Suturas de cortes y heridas en Pasadena, TX: limpieza, anestesia local, puntos o grapas, refuerzo de tétanos si hace falta y retiro de puntos. Sin cita.",
    "descriptionEn": "Stitches for cuts and wounds in Pasadena, TX: cleaning, local anesthesia, sutures or staples, tetanus booster if needed and suture removal. Walk in.",
    "longDescription": "Un corte profundo en la cocina, en el trabajo o jugando cierra mejor y deja menos cicatriz si se sutura en las primeras horas. En Clínica Hispana Corazón y Vida, en Pasadena, limpiamos y cerramos heridas con anestesia local, sin cita y en español, y le retiramos los puntos cuando toca.\n\n## ¿Qué heridas suturamos?\n\n- Cortes en manos, brazos, piernas, cara y cuero cabelludo.\n- Heridas por cuchillo, vidrio, lámina o herramientas.\n- Raspones profundos y desgarros de piel.\n- Heridas de más de medio centímetro de profundidad o cuyos bordes se separan.\n\nHeridas con hueso o tendón expuesto, sangrado que no para con presión, mordeduras profundas o cortes muy grandes se atienden en emergencias; si tiene dudas, llámenos y le orientamos.\n\n## ¿Cuánto tiempo tengo para suturar?\n\nLo ideal es dentro de las primeras seis a ocho horas; en la cara puede extenderse hasta 24 horas. Después de ese tiempo, la herida se limpia y se deja cicatrizar por sí sola para reducir el riesgo de infección. Mientras llega, lave con agua limpia, presione con una gasa y no aplique remedios caseros.\n\n## ¿Cómo es el procedimiento?\n\n1. Se revisa la herida y su historial: tétanos, diabetes, anticoagulantes, alergias.\n2. Anestesia local; siente un pinchazo y luego nada.\n3. Limpieza a fondo y retiro de cuerpos extraños.\n4. Cierre con puntos, grapas o adhesivo según el tipo de herida.\n5. Vendaje, refuerzo de tétanos si su última dosis fue hace más de cinco años, e indicaciones por escrito.\n\nLa visita suele tomar entre 30 y 45 minutos.\n\n## ¿Cómo cuido los puntos?\n\nMantenga la herida limpia y seca las primeras 24 a 48 horas, luego lave con agua y jabón suave y seque sin frotar. No sumerja la zona en piscina o tina. Consulte de inmediato si aparece enrojecimiento que se extiende, pus, dolor creciente o fiebre.\n\n## ¿Cuándo se retiran los puntos?\n\n- Cara: 5 a 7 días.\n- Cuero cabelludo, brazos y tronco: 7 a 10 días.\n- Piernas, manos y zonas de movimiento: 10 a 14 días.\n\nEl retiro se hace en la clínica sin cita y toma pocos minutos.\n\n## ¿Cuánto cuesta?\n\nLa sutura tiene precio directo según el tamaño y la zona de la herida, sin seguro, en efectivo o con tarjeta; el retiro de puntos está incluido. Confirme por WhatsApp al (346) 646-2974.\n\n## ¿Dónde y cuándo?\n\nSin cita en 918 W Southmore Ave, Suite 180, Pasadena, TX 77502, todos los días de 9 AM a 9 PM. Vea también la [curación de heridas](/services/curacion-heridas).",
    "longDescriptionEn": "A deep cut in the kitchen, at work or while playing closes better and leaves less scarring when it is stitched within the first hours. At Clínica Hispana Corazón y Vida in Pasadena we clean and close wounds under local anesthesia, without an appointment and in Spanish, and remove the stitches when the time comes.\n\n## Which wounds do we stitch?\n\n- Cuts on hands, arms, legs, face and scalp.\n- Wounds from knives, glass, sheet metal or tools.\n- Deep scrapes and skin tears.\n- Wounds deeper than half a centimeter or whose edges pull apart.\n\nWounds with exposed bone or tendon, bleeding that does not stop with pressure, deep bites or very large cuts are treated in the emergency room; if in doubt, call us and we will guide you.\n\n## How long do I have to get stitches?\n\nIdeally within the first six to eight hours; on the face it can extend up to 24 hours. After that, the wound is cleaned and left to heal on its own to reduce the risk of infection. In the meantime, wash with clean water, press with gauze and do not apply home remedies.\n\n## What is the procedure like?\n\n1. The wound and your history are reviewed: tetanus, diabetes, blood thinners, allergies.\n2. Local anesthesia; you feel a pinch and then nothing.\n3. Thorough cleaning and removal of foreign bodies.\n4. Closure with sutures, staples or adhesive depending on the wound.\n5. Dressing, tetanus booster if your last dose was more than five years ago, and written instructions.\n\nThe visit usually takes 30 to 45 minutes.\n\n## How do I care for the stitches?\n\nKeep the wound clean and dry for the first 24 to 48 hours, then wash with mild soap and water and pat dry. Do not soak the area in a pool or tub. Come in right away if redness spreads, there is pus, growing pain or fever.\n\n## When are the stitches removed?\n\n- Face: 5 to 7 days.\n- Scalp, arms and trunk: 7 to 10 days.\n- Legs, hands and areas that move: 10 to 14 days.\n\nRemoval is done at the clinic without an appointment and takes a few minutes.\n\n## How much does it cost?\n\nStitches have a direct price according to the size and location of the wound, no insurance, in cash or by card; suture removal is included. Confirm on WhatsApp at (346) 646-2974.\n\n## Where and when?\n\nWalk in at 918 W Southmore Ave, Suite 180, Pasadena, TX 77502, every day from 9 AM to 9 PM. See also [wound care](/services/curacion-heridas).",
    "icon": "Scissors",
  ...
  },
  {
    ...
    "description": "Curación de heridas en Pasadena, TX: limpieza, apósitos, cambio de vendajes y vigilancia de infección en heridas, quemaduras leves y pie diabético.",
    "descriptionEn": "Wound care in Pasadena, TX: cleaning, dressings, bandage changes and infection monitoring for wounds, minor burns, ulcers and diabetic foot. Walk in.",
    "longDescription": "Una herida que se cura mal se infecta, tarda semanas más en cerrar y puede terminar en el hospital, sobre todo en personas con diabetes. En Clínica Hispana Corazón y Vida, en Pasadena, limpiamos, curamos y vendamos heridas, y damos seguimiento hasta que cierran, en español y sin cita.\n\n## ¿Qué heridas curamos?\n\n- Cortes, raspones y heridas después de una sutura o cirugía menor.\n- Quemaduras leves de primer y segundo grado de poca extensión.\n- Úlceras en piernas por mala circulación o varices.\n- Heridas del pie en personas con diabetes.\n- Heridas infectadas que necesitan limpieza y antibiótico.\n- Ampollas, laceraciones por trabajo y heridas que no cierran.\n\nQuemaduras extensas o en cara y manos, heridas con hueso expuesto o infecciones con fiebre alta se atienden en emergencias.\n\n## ¿Qué incluye cada curación?\n\n- Revisión de la herida: tamaño, profundidad, tejido y signos de infección.\n- Limpieza con solución estéril y retiro de tejido muerto cuando hace falta.\n- Apósito adecuado al tipo de herida: húmedo, absorbente o con plata según el caso.\n- Vendaje y protección.\n- Antibiótico cuando hay infección y refuerzo de tétanos si corresponde.\n- Fecha del siguiente cambio y plan de cuidado en casa por escrito.\n\n## ¿Cada cuánto debo venir?\n\nDepende de la herida: las limpias se revisan cada dos a tres días; las infectadas o con mucho exudado, a diario los primeros días. En el pie diabético el seguimiento es más estrecho porque las complicaciones aparecen rápido. Le indicamos las fechas y puede venir sin cita.\n\n## ¿Qué señales de infección debo vigilar?\n\nEnrojecimiento que se extiende, calor, hinchazón, pus o mal olor, dolor que aumenta en vez de disminuir, fiebre o líneas rojas que suben por la piel. Con cualquiera de ellas, venga el mismo día.\n\n## ¿Cómo cuido la herida en casa?\n\nLávese las manos antes de tocarla, mantenga el vendaje limpio y seco, no use alcohol ni agua oxigenada sobre el tejido en cicatrización, coma proteína suficiente y, si tiene diabetes, mantenga la glucosa controlada: es lo que más acelera el cierre.\n\n## ¿Qué materiales usamos?\n\nSolución salina estéril para limpiar, apósitos que mantienen la humedad adecuada para que el tejido nuevo crezca, apósitos absorbentes cuando hay mucho exudado y apósitos con plata en heridas infectadas. Los materiales están incluidos en la curación y le indicamos cuáles puede comprar para los cambios en casa.\n\n## ¿Cuánto cuesta?\n\nCada curación tiene precio directo, sin seguro, en efectivo o con tarjeta; los materiales están incluidos. Confirme por WhatsApp al (346) 646-2974.\n\n## ¿Dónde y cuándo?\n\nSin cita en 918 W Southmore Ave, Suite 180, Pasadena, TX 77502, todos los días de 9 AM a 9 PM. Vea también las [suturas de heridas](/services/suturas-heridas) y el control de [diabetes](/services/condiciones-cronicas).",
    "longDescriptionEn": "A wound that heals poorly gets infected, takes weeks longer to close and can end in the hospital, especially in people with diabetes. At Clínica Hispana Corazón y Vida in Pasadena we clean, treat and dress wounds and follow them until they close, in Spanish and without an appointment.\n\n## Which wounds do we treat?\n\n- Cuts, scrapes and wounds after stitches or minor surgery.\n- Minor first- and second-degree burns of small extent.\n- Leg ulcers from poor circulation or varicose veins.\n- Foot wounds in people with diabetes.\n- Infected wounds that need cleaning and antibiotics.\n- Blisters, work lacerations and wounds that will not close.\n\nExtensive burns or burns on the face and hands, wounds with exposed bone or infections with high fever are treated in the emergency room.\n\n## What does each wound care visit include?\n\n- Wound review: size, depth, tissue and signs of infection.\n- Cleaning with sterile solution and removal of dead tissue when needed.\n- A dressing suited to the wound type: moist, absorbent or silver-based depending on the case.\n- Bandage and protection.\n- Antibiotics when there is infection and a tetanus booster when appropriate.\n- The date of the next change and a written home-care plan.\n\n## How often should I come?\n\nIt depends on the wound: clean ones are checked every two to three days; infected ones or those with heavy drainage, daily in the first days. For diabetic foot the follow-up is closer because complications appear fast. We give you the dates and you can walk in.\n\n## Which signs of infection should I watch for?\n\nSpreading redness, warmth, swelling, pus or a bad smell, pain that increases instead of decreasing, fever or red streaks moving up the skin. With any of them, come in the same day.\n\n## How do I care for the wound at home?\n\nWash your hands before touching it, keep the dressing clean and dry, do not use alcohol or hydrogen peroxide on healing tissue, eat enough protein and, if you have diabetes, keep your glucose controlled: that is what speeds up closure the most.\n\n## How much does it cost?\n\nEach wound care visit has a direct price, no insurance, in cash or by card; supplies are included. Confirm on WhatsApp at (346) 646-2974.\n\n## Where and when?\n\nWalk in at 918 W Southmore Ave, Suite 180, Pasadena, TX 77502, every day from 9 AM to 9 PM. See also [stitches](/services/suturas-heridas) and [diabetes](/services/condiciones-cronicas) management.",
    "icon": "FirstAid",
  ...
  },
  {
    ...
    "description": "Cirugías menores ambulatorias en Pasadena, TX: extracción de lunares, quistes, lipomas y verrugas con anestesia local y cuidados explicados. Sin cita.",
    "descriptionEn": "Outpatient minor surgery in Pasadena, TX: removal of moles, cysts, lipomas and warts under local anesthesia, with aftercare explained. Walk in.",
    "longDescription": "Un lunar que molesta con la ropa, un quiste que crece o una bolita de grasa bajo la piel se resuelven en un procedimiento de menos de una hora, sin hospital. En Clínica Hispana Corazón y Vida, en Pasadena, hacemos cirugías menores con anestesia local, en español y sin cita, y le explicamos cada paso antes de empezar.\n\n## ¿Qué procedimientos hacemos?\n\n- Extracción de lunares y lesiones de piel, con envío a patología cuando el aspecto lo aconseja.\n- Extirpación de quistes sebáceos y quistes de inclusión.\n- Extracción de lipomas pequeños y medianos.\n- Retiro de verrugas y papilomas cutáneos.\n- Biopsias de piel.\n- Retiro de cuerpos extraños superficiales, como astillas o vidrio.\n\nLesiones muy grandes, en zonas delicadas o con sospecha de malignidad se refieren al especialista después de la evaluación.\n\n## ¿Cómo sé si un lunar debe revisarse?\n\nUse la regla ABCDE: Asimetría, Bordes irregulares, Color con varios tonos, Diámetro mayor de seis milímetros y Evolución, es decir, que cambie de tamaño, forma o color, sangre o pique. Cualquiera de esos signos merece consulta aunque no duela.\n\n## ¿Cómo es el procedimiento?\n\n1. Consulta previa: se examina la lesión y se revisa su historial, medicamentos y alergias.\n2. Limpieza de la piel y anestesia local; siente un pinchazo y presión, no dolor.\n3. Extracción de la lesión y cierre con puntos o adhesivo según el caso.\n4. Vendaje, indicaciones escritas y, si se envió a patología, el plazo del resultado.\n\nLa mayoría de los procedimientos toma entre 20 y 45 minutos y puede irse por su cuenta.\n\n## ¿Qué cuidados necesito después?\n\nMantenga el vendaje limpio y seco 24 a 48 horas, evite esfuerzos con esa zona, no sumerja la herida en agua y vuelva para retirar los puntos en el plazo indicado. Consulte si hay sangrado que no para, pus, fiebre o dolor que aumenta.\n\n## ¿Cuándo no conviene operar en la clínica?\n\nCuando la lesión mide varios centímetros, está en párpados, labios o zonas con nervios superficiales, sangra con facilidad o tiene rasgos que sugieren malignidad. En esos casos hacemos la evaluación y la biopsia si procede, y lo referimos al cirujano o dermatólogo con el informe.\n\n## ¿Cuánto cuesta?\n\nCada procedimiento tiene precio directo según el tipo y tamaño de la lesión, sin seguro, en efectivo o con tarjeta; el estudio de patología, cuando se necesita, se cobra aparte. Confirme por WhatsApp al (346) 646-2974 después de la evaluación.\n\n## ¿Dónde y cuándo?\n\nSin cita en 918 W Southmore Ave, Suite 180, Pasadena, TX 77502, todos los días de 9 AM a 9 PM. Vea también el [drenaje de abscesos](/services/drenaje-abscesos) y la [extracción de uñas encarnadas](/services/unas-encarnadas).",
    "longDescriptionEn": "A mole that rubs against clothing, a cyst that keeps growing or a fatty lump under the skin can be solved in a procedure of under an hour, without a hospital. At Clínica Hispana Corazón y Vida in Pasadena we perform minor surgery under local anesthesia, in Spanish and without an appointment, and explain every step before starting.\n\n## Which procedures do we perform?\n\n- Removal of moles and skin lesions, sent to pathology when their appearance calls for it.\n- Excision of sebaceous cysts and inclusion cysts.\n- Removal of small and medium lipomas.\n- Removal of warts and skin tags.\n- Skin biopsies.\n- Removal of superficial foreign bodies, such as splinters or glass.\n\nVery large lesions, those in delicate areas or with suspected malignancy are referred to a specialist after evaluation.\n\n## How do I know if a mole should be checked?\n\nUse the ABCDE rule: Asymmetry, irregular Borders, Color with several shades, Diameter over six millimeters and Evolution, meaning it changes in size, shape or color, bleeds or itches. Any of those signs deserves a visit even if it does not hurt.\n\n## What is the procedure like?\n\n1. A prior consultation: the lesion is examined and your history, medications and allergies are reviewed.\n2. Skin cleaning and local anesthesia; you feel a pinch and pressure, not pain.\n3. Removal of the lesion and closure with stitches or adhesive depending on the case.\n4. Dressing, written instructions and, if sent to pathology, the turnaround for the result.\n\nMost procedures take 20 to 45 minutes and you can leave on your own.\n\n## What aftercare do I need?\n\nKeep the dressing clean and dry for 24 to 48 hours, avoid straining that area, do not soak the wound in water and return to have the stitches removed on schedule. Come in if there is bleeding that does not stop, pus, fever or increasing pain.\n\n## When is the clinic not the right place to operate?\n\nWhen the lesion measures several centimeters, sits on the eyelids, lips or areas with superficial nerves, bleeds easily or has features suggesting malignancy. In those cases we do the evaluation and biopsy if appropriate, and refer you to a surgeon or dermatologist with the report.\n\n## How much does it cost?\n\nEach procedure has a direct price according to the type and size of the lesion, no insurance, in cash or by card; the pathology study, when needed, is charged separately. Confirm on WhatsApp at (346) 646-2974 after the evaluation.\n\n## Where and when?\n\nWalk in at 918 W Southmore Ave, Suite 180, Pasadena, TX 77502, every day from 9 AM to 9 PM. See also [abscess drainage](/services/drenaje-abscesos) and [ingrown toenail removal](/services/unas-encarnadas).",
    "icon": "Scissors",
  ...
  },
  {
    ...
    "description": "Drenaje de abscesos en Pasadena, TX: incisión con anestesia local, limpieza, antibiótico cuando hace falta y cambio de gasa hasta que cierra. Sin cita.",
    "descriptionEn": "Abscess drainage in Pasadena, TX: incision under local anesthesia, cleaning, antibiotics when needed and packing changes until it closes. Walk in.",
    "longDescription": "Un absceso es una bolsa de pus bajo la piel que duele, está caliente y crece cada día. Los antibióticos solos no lo curan: hay que drenarlo. En Clínica Hispana Corazón y Vida, en Pasadena, lo hacemos con anestesia local en una visita corta, sin cita y en español, y le seguimos hasta que cierra.\n\n## ¿Cómo sé si es un absceso?\n\n- Bulto rojo, caliente y doloroso que se ablanda en el centro.\n- Pus que sale solo o al presionar.\n- Fiebre o malestar en los casos más grandes.\n- Aparece con frecuencia en axilas, ingles, glúteos, espalda, cara y alrededor de un vello o una espinilla.\n\nUn forúnculo pequeño puede resolverse con compresas tibias; cuando mide más de un centímetro, duele mucho o lleva varios días sin abrirse, conviene drenarlo.\n\n## ¿Cómo es el procedimiento?\n\n1. Revisión del absceso y del historial: diabetes, medicamentos, abscesos previos.\n2. Anestesia local alrededor de la zona.\n3. Incisión pequeña, salida del pus y limpieza de la cavidad con solución estéril.\n4. Colocación de una gasa dentro de la cavidad en los abscesos grandes, para que cierre desde el fondo.\n5. Vendaje, antibiótico cuando hay celulitis alrededor o factores de riesgo, e indicaciones escritas.\n\nEl alivio del dolor es inmediato al salir el pus. La visita toma entre 20 y 40 minutos.\n\n## ¿Qué pasa después?\n\nVuelva en uno a tres días para cambiar la gasa y revisar la herida; en abscesos grandes hacen falta varios cambios. Cierra desde adentro hacia afuera en una a dos semanas. Lave la zona con agua y jabón, cubra con gasa limpia y no apriete ni intente drenarlo usted mismo.\n\n## ¿Cuándo es urgente?\n\nEnrojecimiento que se extiende rápido, fiebre alta, absceso en la cara cerca de la nariz o los ojos, en la zona genital o en una persona con diabetes descontrolada o defensas bajas. En esos casos acuda a emergencias si la clínica está cerrada.\n\n## ¿Por qué me salen abscesos repetidos?\n\nAfeitado, roce, sudor, diabetes, tabaco y una bacteria en la piel que se llama estafilococo. Cuando se repiten, revisamos la glucosa y le indicamos medidas de higiene y, a veces, un tratamiento para reducir la bacteria en la piel.\n\n## ¿Cuánto cuesta?\n\nEl drenaje tiene precio directo, sin seguro, en efectivo o con tarjeta; los cambios de gasa se cobran como curaciones. Confirme por WhatsApp al (346) 646-2974.\n\n## ¿Dónde y cuándo?\n\nSin cita en 918 W Southmore Ave, Suite 180, Pasadena, TX 77502, todos los días de 9 AM a 9 PM. Vea también las [cirugías menores](/services/cirugias-menores).",
    "longDescriptionEn": "An abscess is a pocket of pus under the skin that hurts, feels hot and grows every day. Antibiotics alone do not cure it: it must be drained. At Clínica Hispana Corazón y Vida in Pasadena we do it under local anesthesia in a short visit, without an appointment and in Spanish, and follow you until it closes.\n\n## How do I know it is an abscess?\n\n- A red, hot, painful lump that softens in the center.\n- Pus that comes out on its own or when pressed.\n- Fever or malaise in larger cases.\n- It often appears in the armpits, groin, buttocks, back, face and around a hair or a pimple.\n\nA small boil may resolve with warm compresses; when it is larger than a centimeter, very painful or has gone several days without opening, it should be drained.\n\n## What is the procedure like?\n\n1. Review of the abscess and your history: diabetes, medications, previous abscesses.\n2. Local anesthesia around the area.\n3. A small incision, release of the pus and cleaning of the cavity with sterile solution.\n4. Placement of packing gauze inside the cavity for large abscesses, so it closes from the bottom.\n5. Dressing, antibiotics when there is surrounding cellulitis or risk factors, and written instructions.\n\nPain relief is immediate once the pus is out. The visit takes 20 to 40 minutes.\n\n## What happens afterwards?\n\nReturn in one to three days for a packing change and wound check; large abscesses need several changes. It closes from the inside out in one to two weeks. Wash the area with soap and water, cover with clean gauze and do not squeeze or try to drain it yourself.\n\n## When is it urgent?\n\nRedness spreading fast, high fever, an abscess on the face near the nose or eyes, in the genital area or in a person with uncontrolled diabetes or a weak immune system. In those cases go to the emergency room if the clinic is closed.\n\n## Why do I keep getting abscesses?\n\nShaving, friction, sweat, diabetes, smoking and a skin bacterium called staphylococcus. When they recur, we check your glucose and recommend hygiene measures and, sometimes, a treatment to reduce the bacteria on the skin.\n\n## How much does it cost?\n\nDrainage has a direct price, no insurance, in cash or by card; packing changes are charged as wound care visits. Confirm on WhatsApp at (346) 646-2974.\n\n## Where and when?\n\nWalk in at 918 W Southmore Ave, Suite 180, Pasadena, TX 77502, every day from 9 AM to 9 PM. See also [minor surgery](/services/cirugias-menores).",
    "icon": "Drop",
  ...
  },
  {
    ...
    "description": "Tratamiento de uña encarnada en Pasadena, TX: retiro de la porción encarnada con anestesia local, tratamiento de la infección y consejos para evitarla.",
    "descriptionEn": "Ingrown toenail treatment in Pasadena, TX: removal of the ingrown portion under local anesthesia, infection treatment and prevention advice. Walk in.",
    "longDescription": "Una uña encarnada empieza como una molestia al calzarse y termina en un dedo rojo, hinchado y con pus que no deja caminar. En Clínica Hispana Corazón y Vida, en Pasadena, retiramos la porción de uña que se clava con anestesia local, tratamos la infección y le explicamos cómo evitar que vuelva, sin cita y en español.\n\n## ¿Cuándo debo venir?\n\n- Dolor en el borde de la uña que empeora con el zapato.\n- Enrojecimiento, hinchazón o pus en el costado del dedo.\n- Un tejido carnoso que crece sobre el borde de la uña.\n- Uña encarnada que se repite aunque se corte bien.\n- Cualquier uña encarnada si tiene diabetes o mala circulación, porque se infecta con facilidad.\n\nEn las etapas iniciales, sin pus, a veces basta con baños tibios y un algodón bajo el borde; si no mejora en unos días, hay que tratarla.\n\n## ¿Cómo es el procedimiento?\n\n1. Revisión del dedo, la uña y el historial: diabetes, circulación, episodios previos.\n2. Anestesia local en la base del dedo; el pinchazo es lo único que siente.\n3. Retiro de la porción encarnada de la uña y limpieza del tejido inflamado.\n4. Cuando la uña se ha encarnado varias veces, se aplica un tratamiento en la raíz de ese borde para que no vuelva a crecer hacia la piel.\n5. Vendaje, antibiótico si hay infección e indicaciones escritas.\n\nEl procedimiento toma entre 20 y 30 minutos y sale caminando, con calzado abierto.\n\n## ¿Cómo cuido el dedo después?\n\nMantenga el vendaje 24 horas, luego lave con agua y jabón, seque bien y cubra con gasa limpia. Use sandalias o zapato amplio unos días, eleve el pie si duele y tome el analgésico indicado. Consulte si hay sangrado que no para, pus o dolor que aumenta.\n\n## ¿Cómo evito que vuelva?\n\nCorte la uña recta, sin redondear las esquinas ni dejarla demasiado corta. Use calzado con espacio en la punta y calcetines que no aprieten. Mantenga los pies secos y, si suda mucho, cambie de calcetines durante el día.\n\n## ¿Qué pasa si ya hay infección?\n\nSi el dedo tiene pus, se drena durante el mismo procedimiento y se indica antibiótico por vía oral durante unos días. Con diabetes o mala circulación el seguimiento es más estrecho, porque una infección del dedo puede extenderse al hueso si se descuida.\n\n## ¿Cuánto cuesta?\n\nEl procedimiento tiene precio directo, sin seguro, en efectivo o con tarjeta; la revisión posterior está incluida. Confirme por WhatsApp al (346) 646-2974.\n\n## ¿Dónde y cuándo?\n\nSin cita en 918 W Southmore Ave, Suite 180, Pasadena, TX 77502, todos los días de 9 AM a 9 PM. Si tiene diabetes, vea también la [curación de heridas](/services/curacion-heridas) del pie.",
    "longDescriptionEn": "An ingrown toenail starts as discomfort when putting on shoes and ends as a red, swollen toe with pus that makes walking hard. At Clínica Hispana Corazón y Vida in Pasadena we remove the portion of nail digging into the skin under local anesthesia, treat the infection and explain how to keep it from coming back, without an appointment and in Spanish.\n\n## When should I come in?\n\n- Pain at the edge of the nail that worsens with shoes.\n- Redness, swelling or pus on the side of the toe.\n- Fleshy tissue growing over the edge of the nail.\n- An ingrown nail that recurs even with careful trimming.\n- Any ingrown toenail if you have diabetes or poor circulation, because it gets infected easily.\n\nIn early stages, without pus, warm soaks and a bit of cotton under the edge are sometimes enough; if it does not improve in a few days, it needs treatment.\n\n## What is the procedure like?\n\n1. Review of the toe, the nail and your history: diabetes, circulation, previous episodes.\n2. Local anesthesia at the base of the toe; the pinch is all you feel.\n3. Removal of the ingrown portion of the nail and cleaning of the inflamed tissue.\n4. When the nail has become ingrown several times, a treatment is applied to the root of that edge so it does not grow into the skin again.\n5. Dressing, antibiotics if there is infection and written instructions.\n\nThe procedure takes 20 to 30 minutes and you walk out, in open footwear.\n\n## How do I care for the toe afterwards?\n\nKeep the dressing on for 24 hours, then wash with soap and water, dry well and cover with clean gauze. Wear sandals or roomy shoes for a few days, elevate the foot if it hurts and take the pain reliever indicated. Come in if there is bleeding that does not stop, pus or increasing pain.\n\n## How do I keep it from coming back?\n\nTrim the nail straight across, without rounding the corners or cutting it too short. Wear shoes with room at the toes and socks that do not squeeze. Keep your feet dry and, if they sweat a lot, change socks during the day.\n\n## How much does it cost?\n\nThe procedure has a direct price, no insurance, in cash or by card; the follow-up check is included. Confirm on WhatsApp at (346) 646-2974.\n\n## Where and when?\n\nWalk in at 918 W Southmore Ave, Suite 180, Pasadena, TX 77502, every day from 9 AM to 9 PM. If you have diabetes, see also foot [wound care](/services/curacion-heridas).",
    "icon": "Bone",
  ...
  },
  {
    ...
    "titleEn": "Pharmacy",
    "shortTitle": "Farmacia",
    "description": "Medicamentos en la clínica en Pasadena, TX: al terminar la consulta recibe los medicamentos indicados y productos de venta libre, explicados en español.",
    "descriptionEn": "In-clinic medications in Pasadena, TX: after your visit you receive the medications indicated and over-the-counter products, explained in Spanish.",
    "longDescription": "Salir de la consulta con el tratamiento en la mano evita un viaje más, una espera en la farmacia y la duda de si compró lo correcto. En Clínica Hispana Corazón y Vida, en Pasadena, al terminar su visita le entregamos los medicamentos que el médico indicó y le explicamos en español cómo y cuándo tomarlos.\n\n## ¿Qué medicamentos puedo recibir en la clínica?\n\n- Los medicamentos indicados por el médico en su consulta de ese día: antibióticos, antiinflamatorios, tratamientos para presión, azúcar, alergias, infecciones y otros de uso común.\n- Medicamentos de venta libre para gripe, dolor, fiebre, alergias, acidez o diarrea.\n- Vitaminas y suplementos, como ácido fólico o vitamina B12.\n- Inyecciones y sueros que se aplican en la misma clínica.\n\nLa disponibilidad depende del inventario del día; cuando un medicamento no está en existencia, se le entrega la receta para surtirla en la farmacia de su elección.\n\n## ¿Qué ventajas tiene?\n\n- Empieza el tratamiento el mismo día, sin esperas ni traslados.\n- El personal le explica dosis, horario, con o sin comida y qué efectos vigilar.\n- Precio conocido antes de pagar, en efectivo o con tarjeta, sin seguro.\n- Cuando existe la opción, se le ofrece el genérico, que cuesta menos.\n\n## ¿Cómo funciona?\n\n1. El médico decide el tratamiento durante la consulta.\n2. En recepción le indican el precio de cada medicamento antes de entregarlo.\n3. Recibe los medicamentos con las indicaciones por escrito y, si tiene dudas, se las aclaran en español.\n4. Si necesita continuar el tratamiento, se revisa en su siguiente consulta.\n\n## ¿Puedo comprar medicamentos sin consulta?\n\nLos productos de venta libre sí, dentro del horario de la clínica. Los medicamentos que requieren indicación médica se entregan únicamente con la consulta del médico de la clínica, que revisa alergias, otros medicamentos y su historial antes de indicarlos.\n\n## ¿Qué debo decirle al médico?\n\nTodos los medicamentos, vitaminas y remedios que toma, aunque sean naturales, sus alergias y si está embarazada o amamantando. Con esa información se evitan interacciones y dosis incorrectas.\n\n## ¿Cuánto cuesta?\n\nCada medicamento tiene su precio, que se informa antes de pagar. Pregunte por WhatsApp al (346) 646-2974 si un producto de venta libre está disponible antes de venir.\n\n## ¿Dónde y cuándo?\n\nEn la misma clínica, 918 W Southmore Ave, Suite 180, Pasadena, TX 77502, todos los días de 9 AM a 9 PM, sin cita. Vea también el control de [diabetes, presión y colesterol](/services/condiciones-cronicas).",
    "longDescriptionEn": "Leaving the visit with your treatment in hand avoids one more trip, a wait at the drugstore and the doubt of whether you bought the right thing. At Clínica Hispana Corazón y Vida in Pasadena, when your visit ends we hand you the medications the provider indicated and explain in Spanish how and when to take them.\n\n## Which medications can I receive at the clinic?\n\n- The medications indicated by the provider at your visit that day: antibiotics, anti-inflammatories, treatments for blood pressure, sugar, allergies, infections and other common ones.\n- Over-the-counter products for colds, pain, fever, allergies, heartburn or diarrhea.\n- Vitamins and supplements, such as folic acid or vitamin B12.\n- Injections and IV drips given at the clinic itself.\n\nAvailability depends on the day's inventory; when a medication is not in stock, you are given the prescription to fill at the pharmacy of your choice.\n\n## What are the advantages?\n\n- You start treatment the same day, without waiting or traveling.\n- Staff explain dose, schedule, with or without food and which effects to watch.\n- The price is known before you pay, in cash or by card, no insurance.\n- When the option exists, you are offered the generic, which costs less.\n\n## How does it work?\n\n1. The provider decides the treatment during the visit.\n2. At the front desk you are told the price of each medication before it is handed over.\n3. You receive the medications with written instructions and, if you have questions, they are answered in Spanish.\n4. If you need to continue the treatment, it is reviewed at your next visit.\n\n## Can I buy medications without a visit?\n\nOver-the-counter products yes, during clinic hours. Medications that require a medical indication are provided only with a visit to the clinic's provider, who reviews allergies, other medications and your history before indicating them.\n\n## What should I tell the provider?\n\nAll the medications, vitamins and remedies you take, even natural ones, your allergies and whether you are pregnant or breastfeeding. With that information, interactions and wrong doses are avoided.\n\n## How much does it cost?\n\nEach medication has its own price, stated before you pay. Ask on WhatsApp at (346) 646-2974 whether an over-the-counter product is available before you come.\n\n## Where and when?\n\nAt the clinic itself, 918 W Southmore Ave, Suite 180, Pasadena, TX 77502, every day from 9 AM to 9 PM, no appointment needed. See also [diabetes, blood pressure and cholesterol](/services/condiciones-cronicas) management.",
    "icon": "Pill",
    ...
    "featuresEn": [
      "Medications from your visit when you leave",
