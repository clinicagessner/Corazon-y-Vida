...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    "description": "Análisis de sangre en Pasadena, TX: biometría, química, glucosa, colesterol y más. Resultados en español, con precios accesibles.",
